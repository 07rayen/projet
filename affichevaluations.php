...
$PackList = $evaluationC->AfficherEvaluations();
?>
<!DOCTYPE html>
<html lang="en">
<!--
...
<body class="cbp-spmenu-push">
    <div class="main-content">
        ...
        <div id="page-wrapper">
            <div class="main-page">
                <div class="tables">
                    <h2 class="title1">Gestion des Small Business</h2>
                    <button class="btn  "><a href="addevaluation.php">Ajouter un nouveau Evaluation </a></button>
                                    <br><br>
                                    <table class="table table-report -mt-2">
                                        <thead>
                                            <tr>
                                                <th class="whitespace-nowrap">Titre</th>
                                                <th class="text-center whitespace-nowrap">Durée</th>
                                        ...
                                        ?>
                                            <tbody>
                                                <tr>
                                                    <td><?php echo $Pack['titreEva']; ?></td>
                                                    <td><?php echo $Pack['duree']; ?></td>
                                                    <td><?php echo $Pack['descE']; ?></td>

                                                    <td class="table-report__action w-56">
                                                        <div class="flex justify-center items-center">
                                                            <a class="btn btn-success btn-sm" name="Modifier" value="" href="updateevaluations.php?id=<?php echo $Pack['idEva']; ?>">Edit</a>
                                                            <a class="btn btn-danger btn-sm" href="deleteevaluations.php?id=<?php echo $Pack['idEva']; ?>">Delete</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
